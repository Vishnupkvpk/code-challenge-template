...
class WeatherStatsCalculatIngestion:
    ...
    def calculate_and_store_stats(self):
        try:
            ...
            if stats_df.empty:
                ...
                # Ensure NULL for missing data
                stats_df['avg_max_temp'] = stats_df['avg_max_temp'].fillna(np.nan)
                stats_df['avg_min_temp'] = stats_df['avg_min_temp'].fillna(np.nan)
                stats_df['total_precipitation'] = stats_df['total_precipitation'].fillna(np.nan)
